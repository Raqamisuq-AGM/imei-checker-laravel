...
class SettingController extends Controller
{
    ...
    {
        return view('pages.dashboard.admin.settings.change-email');
    }

    //change password method
    public function changePassword()
    {
        return view('pages.dashboard.admin.settings.change-password');
    }
    ...
    public function updateEmail(Request $request)
    {
        ...
        return redirect()->route('admin.setting.change-email');
    }
    ...
    public function updatePassword(Request $request)
    {
        ...
        return redirect()->route('dashboard.setting.change-password');
    }
}
