                            ...
                            <div class="accordion-body">
                                <form role="form" action="{{ route('stripe.post') }}" method="post"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control card-number" placeholder="" name="amount"
                                            required>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="password" class="form-control card-cvc" required>
                                            </div>
                                        </div>
                                    </div>
                                    <button class="btn btn-primary w-100 mt-2" id="srtipe-pay">Pay now</button>
                                </form>
                            </div>
                        </div>
                    </div>
