...
class ServicesTableSeeder extends Seeder
{
    ...
    {
        $services = [
            ['service_id' => 1, 'title' => 'Find My iPhone [ FMI ] (ON/OFF)', 'price' => 0.31],
            ['service_id' => 2, 'title' => 'Warranty + Activation - PRO [IMEI/SN]', 'price' => 0.32],
            ['service_id' => 3, 'title' => 'Apple FULL INFO [No Carrier]', 'price' => 0.37],
            ['service_id' => 4, 'title' => 'iCloud Clean/Lost Check', 'price' => 0.32],
            ['service_id' => 5, 'title' => 'Blacklist Status (GSMA)', 'price' => 0.32],
            ...
            ['service_id' => 10, 'title' => 'IMEI to Model [all brands][IMEI/SN]', 'price' => 0.31],
            ['service_id' => 11, 'title' => 'IMEI to Brand/Model/Name', 'price' => 0.31],
            ['service_id' => 12, 'title' => 'GSX Next Tether + iOS (GSX Carrier)', 'price' => 0.90],
            ['service_id' => 13, 'title' => 'Model + Color + Storage + FMI', 'price' => 0.32],
            ['service_id' => 14, 'title' => 'IMEI to SN (Full Convertor)', 'price' => 0.32],
            ...
            ['service_id' => 20, 'title' => 'Apple SimLock Check', 'price' => 0.32],
            ...
            ['service_id' => 33, 'title' => 'Replacement Status (Active Device)', 'price' => 0.31],
            ['service_id' => 34, 'title' => 'Replaced Status (Original Device)', 'price' => 0.31],
            ...
            ['service_id' => 50, 'title' => 'Apple SERIAL Info(model,size,color)', 'price' => 0.31],
            ['service_id' => 51, 'title' => 'Warranty + Activation [SN ONLY]', 'price' => 0.31],
            ['service_id' => 52, 'title' => 'Model Description (Any Apple SN/IMEI)', 'price' => 0.32],
